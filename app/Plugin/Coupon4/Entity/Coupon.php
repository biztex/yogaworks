...
class Coupon extends AbstractEntity
{
     ...
     * @var int
     *
     * @ORM\Column(name="free_shipping", type="smallint", nullable=true)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="free_fee", type="smallint", nullable=true)
     */
    private $free_fee;
     ...
     * @return Coupon
     */
    public function setFreeFee($freeFee)
    {
        $this->free_fee = $freeFee;
