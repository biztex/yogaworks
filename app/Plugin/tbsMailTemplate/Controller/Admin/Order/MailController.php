...
namespace Plugin\tbsMailTemplate\Controller\Admin\Order;
...
use Plugin\tbsMailTemplate\Service\MailService;
...
class MailController extends AbstractController
{
    ...
    /**
     * @Route("%eccube_admin_route%/tbs_mail_template/order/{id}/mail", requirements={"id" = "\d+"}, name="tbs_mail_template_admin_order_mail")
     * @Template("@tbsMailTemplate/admin/Order/mail.twig")
     */
            ...
            switch ($mode) {
                case 'change':
                    if ($form->get('template')->isValid()) {
                        ...
                        if ($MailTemplate) {
                            ...
                            // HTMLファイル用
                            $htmlTwig = $this->getHtmlFileName($twig);
                ...
                case 'confirm':
                    if ($form->isValid()) {
                        ...
                        return $this->render('@tbsMailTemplate/admin/Order/mail_confirm.twig', [
                ...
                case 'complete':
                    if ($form->isValid()) {
                        ...
                        $MailHistory
                            ...
                            ->setMailHtmlBody($message->getBody())
    ...
    /**
     * @Route("%eccube_admin_route%/tbs_mail_template/order/mail/view", requirements={"id" = "\d+"}, name="tbs_mail_template_admin_order_mail_view")
