...
class SearchOrderType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('shipping_shipping_datetime_start', DateTimeType::class, [
                'label' => '発送日(開始)',
                'required' => false,
                'input' => 'datetime',
                'widget' => 'single_text',
                ...
                'attr' => [
                    'class' => 'datetimepicker-input',
                    'data-target' => '#'.$this->getBlockPrefix().'_shipping_shipping_datetime_start',
                    'data-toggle' => 'datetimepicker',
                ],
            ])
            ->add('shipping_shipping_datetime_end', DateTimeType::class, [
                'label' => ' 発送日(終了)',
                'required' => false,
                'input' => 'datetime',
                'widget' => 'single_text',
                ...
                'attr' => [
                    'class' => 'datetimepicker-input',
                    'data-target' => '#'.$this->getBlockPrefix().'_shipping_shipping_datetime_end',
                    'data-toggle' => 'datetimepicker',
                ],
            ])
        ;
