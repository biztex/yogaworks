...
class OrderRepository extends AbstractRepository
{
    ...
    public function getQueryBuilderBySearchDataForAdmin($searchData)
    {
        ...
        // 発送日(Shipping.shipping_date)
        if (!empty($searchData['shipping_shipping_datetime_start']) && $searchData['shipping_shipping_datetime_start']) {
            $date = $searchData['shipping_shipping_datetime_start'];
            $qb
                ->andWhere('s.shipping_date >= :shipping_date_start')
                ->setParameter('shipping_date_start', $date);
        }

        if (!empty($searchData['shipping_shipping_datetime_end']) && $searchData['shipping_shipping_datetime_end']) {
            $date = $searchData['shipping_shipping_datetime_end'];
            $qb
